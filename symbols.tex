...
\newcommand{\Action}[5][]{\subsection[#5]{#5\ActionSymbol{#4} \ActionTraits{#1} \hfill \Reference{#2}{#3}}}

\NewDocumentCommand{\Activity}{ommmm}{\subsection[#5]{#5 {\small\engschrift (#4)}\ActionTraits{#1} \hfill \Reference{#2}{#3}}}
