...
\newcommand{\Item}[2]{\Card{Item}{#1}{#2}}
\newcommand{\Spell}[2]{\Card{Spell}{#1}{#2}}
\newcommand{\Cantrip}[2]{\Card{Cantrip}{#1}{#2}}
\newcommand{\FocusSpell}[2]{\Card{Focus}{#1}{#2}}
